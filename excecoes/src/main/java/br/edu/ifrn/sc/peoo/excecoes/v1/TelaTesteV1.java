 ...
 */
public class TelaTesteV1 extends javax.swing.JFrame {
    ...
    private void jbtDividirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtDividirActionPerformed
        ...
        if (resultado != Integer.MIN_VALUE) {
            ...
            JOptionPane.showMessageDialog(this, "Não é possível dividir por 0. Corrija os valores e tente novamente");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaTesteV1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaTesteV1().setVisible(true);
            }
        });
    }
